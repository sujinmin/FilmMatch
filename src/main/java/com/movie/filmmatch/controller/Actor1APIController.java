...
@Controller
@RequestMapping("/main/")
public class Actor1APIController {

    @RequestMapping("/actorameri.do")
    public static List<ActorVo> search_actorameri() throws Exception {
        ...
        String urlStr = "https://api.themoviedb.org/3/search/person?query=Rebecca%20Ferguson&include_adult=false&language=ko&page=1&api_key=" + clientId;
