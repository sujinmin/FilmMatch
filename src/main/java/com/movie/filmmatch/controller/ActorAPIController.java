...
public class ActorAPIController {
    ...
    @RequestMapping("/actorapi.do")
    public static List<ActorVo> search_actor() throws Exception {
        ...
        String urlStr = "https://api.themoviedb.org/3/search/person?query=Lee%20Byung-hun&include_adult=false&language=ko&page=1&api_key=" + clientId;
