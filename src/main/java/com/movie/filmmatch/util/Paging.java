...
public static String getGoodsPaging(String pageURL,String search_filter,int nowPage, int rowTotal,int blockList, int blockPage){
		...
		sb = new StringBuffer("<div class=\"paging\"  >");
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append(String.format("<a href ='%s?page=%d%s'>◀</a>&nbsp;&nbsp;", 
...
//------페이지 목록 출력 -------------------------------------------------------------------------------------------------
		...
		for(int i=startPage; i<= endPage ;i++){
			...
			if(i == nowPage){ //현재 있는 페이지
				...
				sb.append(String.format("&nbsp;&nbsp;<a href ='%s?page=%d%s'>%d</a>&nbsp;&nbsp;", 
