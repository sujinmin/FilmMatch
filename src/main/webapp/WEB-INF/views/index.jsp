...
<body>
	...
	<header id="header">
		<div class="inner">
			...
			<nav id="nav">
				<a href="index.html">Home</a> <a href="generic.html">Generic</a> <a href="elements.html">Elements</a>
			</nav>
		</div>
	</header>
	...
	<section id="banner">
		<div class="inner">
			<h1>
				Introspect: <span>A free + fully responsive<br> site template by TEMPLATED
				</span>
			</h1>
			<ul class="actions">
		...
		<div class="inner">
			<article>
				<div class="content">
					...
					<div class="image fit">
						<img src="${ pageContext.request.contextPath }/image/pic01.jpg" alt="" width="473" height="220">
					</div>
			...
			<article class="alt">
				<div class="content">
					...
					<div class="image fit">
						<img src="${ pageContext.request.contextPath }/image/pic02.jpg" alt="" width="473" height="220">
					</div>
					<p>Cumsan mollis eros. Pellentesque a diam sit amet mi magna ullamcorper vehicula. Integer adipiscin sem. Nullam quis massa sit amet lorem ipsum feugiat tempus.</p>
				</div>
			</article>
