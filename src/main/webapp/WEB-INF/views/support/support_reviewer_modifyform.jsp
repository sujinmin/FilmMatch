        ...
        <div class="row">
            ...
            <form class="table-wrapper"> <!--  action="form-inline" -->
                ...
                <table class="table-wrapper">
                    ...
                    <tr>
                        <th>제목</th>
                        <td><input class="query" type="text" name="r_subject" value="${ vo.r_subject }"></td>
                     </tr>
                     <tr>
                        <th>내용</th>
                        <td><textarea class="message" rows="5" name="r_content" >${ vo.r_content }</textarea></td>
                     </tr>
