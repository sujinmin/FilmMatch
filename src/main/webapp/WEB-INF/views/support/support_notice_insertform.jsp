...
<script type="text/javascript">
	...
	function send(f) {
		...
		alert('공지사항에 글을 올렸습니다');
		f.action ="notice_insert.do"; // /support/qna_insert.do -> supportController
		f.submit();
    }
            ...
            <div class="col-sm-8">
                ...
                <table>   
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>제목</th>
                        <td><input class="form-control" name="n_subject" style="width: 100%;"></td>
                    </tr> 
                    <tr>

                        <th>내용</th>
                        <td><textarea class="form-control" rows="5" name="n_content"></textarea></td>
                    </tr>
                    
                    <tr>
                        <td colspan="2" align="center">
                            <input type="button" class="btn btn-primary" value="공지글올리기" 
