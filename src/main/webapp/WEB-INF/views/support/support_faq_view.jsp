...
-->
	...
	* {
	...
	//삭제
	location.href="faq_delete.do?f_idx="+ f_idx
	...
	function faq_modifyform(f_idx) {
		
		let community_page="${param.community_page}";
		//console.log(b_idx);
		location.href="faq_modifyform.do?f_idx=" + f_idx; //수정 폼 페이지
	...
	<section id="one">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-3">
				<input class="btn btn-success" type="button" value="자찾문올리기"
						onclick="location.href='faq_insertform.do'">
				</div>
				<br>
				<br>
						...
						<div id="box">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<div id="subject"><b>제목:</b>${ vo.f_subject }</div>
									<div id="content">${ vo.f_content }</div>
									<div id="regdate"
										style="display: flex; justify-content: space-between;">
										<div>
											<b>작성일자:</b> ${ vo.f_regdate }
										</div>
										<div>
											<b>IP:</b> ${ vo.f_ip }
										</div>
						...
						<tr>
							<td colspan="2" align="center">
								...
								<input type="button" class="button special" value="수정하기"
										onclick="faq_modifyform('${vo.f_idx}');">&nbsp;
								<input class="button alt" type="button" value="삭제하기"
										onclick="del('${ vo.f_idx }');">&nbsp;
								</c:if>
