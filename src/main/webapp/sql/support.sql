...
CREATE TABLE `support` (
  ...
  `b_readhit` int DEFAULT '0',
  `b_ref` int DEFAULT NULL,
  `b_step` int DEFAULT NULL,
  `b_depth` int DEFAULT NULL,
  `b_use` varchar(10) DEFAULT NULL,
  `mem_idx` int NOT NULL,
  `mem_name` varchar(200) NOT NULL,
  `community_page` int NOT NULL,
  PRIMARY KEY (`b_idx`)
...
-- Dump completed on 2024-03-22 16:05:36
