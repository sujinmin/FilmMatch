...
-- sample db (관리자:판매자)=1, 일반=2, 평론가 =3
INSERT INTO `moviedb`.`member` (`mem_idx`, `mem_name`, `mem_id`, `mem_pwd`, `mem_email`, `mem_phone`, `mem_addr`, `mem_ip`, `mem_regdate`, `mem_modifydate`, `mem_grade`, `mem_zipcode`,`policy_a`,`policy_b`) VALUES ('1', '홍길동', 'one', '1234', 'hong@ictedu.com', '010-0000-0000' '서울시 강남구', '000.000.00.0', '2024-03-19 19:13:40', '2024-03-19 19:13:40', '1', '1111','policy_a_agree','policy_b_agree');
